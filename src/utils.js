...
const createSprite = (name) => {
    const texture = new THREE.TextureLoader().load(`https://raw.githubusercontent.com/yuhaowang774/3DSolarSystem1/refs/heads/main/assets/${name}.png`);
...
const createSun = (name, radius) => {
    const texture = new THREE.TextureLoader().load(`https://raw.githubusercontent.com/yuhaowang774/3DSolarSystem1/refs/heads/main/assets/${name}.jpg`);
...
const createPlanet = (name, radius) => {
    ...
    const texture = new THREE.TextureLoader().load(`https://raw.githubusercontent.com/yuhaowang774/3DSolarSystem1/refs/heads/main/assets/${name}.jpg`);
    if(name == 'earth') {
        texture1 = new THREE.TextureLoader().load(`https://raw.githubusercontent.com/yuhaowang774/3DSolarSystem1/refs/heads/main/assets/earth_normal_map.png`);
        texture2 = new THREE.TextureLoader().load(`https://raw.githubusercontent.com/yuhaowang774/3DSolarSystem1/refs/heads/main/assets/earth_specular_map.png`);
...
const createRing = (name, innerRadius, outerRadius) => {
    ...
    const ringTexture = ringTextureLoader.load(`https://raw.githubusercontent.com/yuhaowang774/3DSolarSystem1/refs/heads/main/assets/${name}.png`);
